...
public class IPTranslate {
	...
	return new Locale[] { new Locale("da", "DA"), Locale.US, Locale.FRENCH,
		Locale.GERMAN, Locale.ITALIAN, Locale.JAPANESE,
		new Locale("pt", "BR"), new Locale("es", "ES") };
    }
    ...
    /**
         ...
         * BMenuItem as an event link for CommandEvents, and the menu item's
         * action command will be set to (name). This also checks for a property
         * called "menu.shortcut.(name)", and if it is found, sets the menu
	...
	try {
		...
		item.setShortcut(new Shortcut(shortcut.charAt(1),
			Shortcut.DEFAULT_MASK | Shortcut.SHIFT_MASK));
    ...
    /**
         ...
         * listener is not null, the specified method of it will be added to the
         * BMenuItem as an event link for CommandEvents, and the menu item's
         * action command will be set to (name). This form of the method allows
         * you to explicitly specify a menu shortcut, rather than using the one
    ...
    public static BMenuItem menuItem(String name, Object listener,
	    String method, Shortcut shortcut) {
	String command = name;
	try {
	    command = resources.getString("menu." + name);
	} catch (MissingResourceException ex) {
    ...
    /**
         ...
         * "menu.(name)". If listener is not null, the specified method of it
         * will be added to the BCheckboxMenuItem as an event link for
    ...
    public static BCheckBoxMenuItem checkboxMenuItem(String name,
	    Object listener, String method, boolean state) {
	String command = name;
	try {
	    command = resources.getString("menu." + name);
	} catch (MissingResourceException ex) {
    ...
    /**
         ...
         * "menu.(name)". If listener is not null, the specified method of it
         * will be added to the BRadioButtonMenuItem as an event link for
         * CommandEvents. state specifies the initial state of the item.
         * 
         * @param name
         *                Description of the Parameter
    ...
    public static BRadioButtonMenuItem radioButtonMenuItem(String name,
	    Object listener, String method, RadioButtonGroup group,
	    boolean state) {
	String command = name;
	try {
	    command = resources.getString("menu." + name);
	...
	BRadioButtonMenuItem item = new BRadioButtonMenuItem(command, state,
		group);
	item.setActionCommand(name);
	try {
	    String shortcut = resources.getString("menu." + name + ".shortcut");
    ...
    /**
         ...
         * listener is not null, the specified method of it will be added to the
         * BButton as an event link for CommandEvents, and the menu item's
         * action command will be set to (name).
         * 
         * @param name
         *                Description of the Parameter
         * @param listener
    ...
    /**
         ...
         * with a suffix appended to it. If listener is not null, the specified
         * method of it will be added to the BButton as an event link for
         * CommandEvents, and the button's action command will be set to (name).
         * 
         * @param name
         *                Description of the Parameter
         * @param suffix
    ...
    public static BButton button(String name, String suffix, Object listener,
	    String method) {
	String command = name;
	try {
    ...
    /**
         * Get a BLabel whose text is given by the property "name", with a
         * suffix appended to it. If the property is not found, this simply uses
         * name.
         * 
         * @param name
         *                Description of the Parameter
    ...
    /**
         * Get the text given by the property "name". If the property is not
         * found, this simply uses name. Any occurrance of the pattern "{0}" in
         * the text string will be replaced with the string representation of
         * arg1.
         * 
         * @param name
         *                Description of the Parameter
    ...
    /**
         * Get the text given by the property "name". If the property is not
         * found, this simply uses name. Any occurrances of the patterns "{0}"
         * and "{1}" in the text string will be replaced with the strings
         * representations of arg1 and arg2, respectively.
         * 
         * @param name
         *                Description of the Parameter
         * @param arg1
    ...
    /**
         * Get the text given by the property "name". If the property is not
         * found, this simply uses name. That string and the args array are then
         * passed to MessageFormat.format() so that any variable fields can be
