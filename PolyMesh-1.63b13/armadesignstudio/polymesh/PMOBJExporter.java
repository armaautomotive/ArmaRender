...
import armadesignstudio.math.Mat4;
...
import armadesignstudio.texture.Mapping2D;
...
public class PMOBJExporter
{
    ...
    public static void writePolyMesh( Scene theScene, PrintWriter out, TextureImageExporter textureExporter, String mtlFilename )
    {
        ...
        //out.println( "#Produced by Art of Illusion " + ArmaDesignStudio.VERSION + ", PolyMesh Plugin, " + ( new Date() ).toString() );
        if ( mtlFilename != null )
    ...
    private static void writeTextures( Scene theScene, PrintWriter out, boolean wholeScene, TextureImageExporter textureExporter )
    {
        ...
        out.println( "#Produced by Arma Design Studio " + ArmaDesignStudio.getVersion() + ", PolyMesh Plugin, " + ( new Date() ).toString() );
