...
import armadesignstudio.SceneViewer;
...
public class CreatePolyMeshTool extends EditingTool
{
    ...
    public CreatePolyMeshTool(EditingWindow fr)
    {
        super(fr);
        edw = fr;
        initButton("polymesh:polymesh_48");
    }
    ...
    public class PolyMeshToolDialog extends BDialog
    {
        ...
        public PolyMeshToolDialog( BFrame parent )
        {
            ...
            try
            {
                ...
                templateStart = 5;
                File templateDir = new File( ArmaDesignStudio.PLUGIN_DIRECTORY + File.separator + "PolyMeshTemplates" + File.separator );
        ...
        private void doOK()
        {
            ...
            else
            {
                ...
                try
                {
                    File file = new File( ArmaDesignStudio.PLUGIN_DIRECTORY + File.separator + "PolyMeshTemplates" + File.separator + (String)typeCombo.getSelectedValue() );
