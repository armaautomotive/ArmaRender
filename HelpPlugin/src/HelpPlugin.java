...
/*
 *  Credits: Some code for this has been copied from the ArmaDesignStudio base
...
public class HelpPlugin implements Plugin
{
    ...
    StringBuffer buff = null;
     ...
     static final int JAVAHELP_LIB	= 1;
     static final int HELPGUI_LIB	= 2;

     static final int MB = 1024*1024;

     static final String mapHeader =
	"<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!DOCTYPE map PUBLIC \"-//Sun Microsystems Inc.//DTD JavaHelp Map Version 1.0//EN\" \"http://java.sun.com/products/javahelp/map_2_0.dtd\"><!-- generated by ArmaDesignStudio HelpPlugin Version: 1.0, see aoisp.sourceforge.net -->\n<map version=\"1.0\">\n";
    ...
    public void processMessage(int message, Object args[])
    {
        ...
        int i, k, c;
        if (AppDir == null)
            AppDir = new File(ArmaDesignStudio.APP_DIRECTORY);
        ...
        case Plugin.SCENE_WINDOW_CREATED:
            ...
            if (!initialised) {
                ...
                */
                ...
                File dir = new File(ArmaDesignStudio.PLUGIN_DIRECTORY, "Help");
                ...
                for (i = 0; i < jars.length; i++) {
                    try {
                        ...
                        System.out.println(": "  + " - " + urlarg[0] );
                        //addURL.setAccessible(true);
                        
                        
                        loader.add((URL)urlarg[0]);
                        
                        //addURL.invoke(myldr, urlarg); // ???  cannot access a member of class java.net.URLClassLoader  with modifiers "protected"
                    } catch (Exception e) {
                ...
                try {
                    ...
                    if (loader.getResource("helpset/AOIHelp.hs") == null) {
                        ...
                        System.out.println("  ****** load helpset failed. ****** ");
                    ...
                    try {
                        ...
                        //Method getbroker = JHelpAction.class.getDeclaredMethod("getHelpBroker", null); // Warning - inexact argument
                        Method getbroker = JHelpAction.class.getDeclaredMethod("getHelpBroker");
                        getbroker.setAccessible(true);
                        
                        //System.out.println("C");

                        //global = (HelpSet)((HelpBroker) getbroker.invoke(null, null)).getHelpSet();
                        global = (HelpSet)((HelpBroker) getbroker.invoke(null)).getHelpSet();    // ERROR
                        helplib = JAVAHELP_LIB;
                        
                        /*
                         JavaHelp HelpSet
                         HelpSet helpset/AOIHelp.hs not created.
                         Could not parse
                         Got an IOException (Cannot invoke "java.net.URL.openConnection()" because "<parameter1>" is null)
                    ...
                    helpurl = HelpSet.findHelpSet(loader, "helpset/AOIHelp", local);
                    //global = new HelpSet(helpurl);  // ERROR
                    global = new HelpSet(loader);
                    System.out.println("1");
                    broker = global.createHelpBroker(); // Error
                    ...
                    if (helplib == 0) {
                        try {
                            ...
                            if( list.size() > 0){
                                ...
                                docset.add("helpset/AOIHelp.hs", null); // error net.sourceforge.helpgui.parser.DocSet.parser" is null
                            } else {
            ...
            try {
                ...
                //helpmenu.add(item=Translate.menuItem("HelpPlugin:AOIHelp", this, "show"));
                //item.setEnabled(enabled);

                //helpmenu.add(item=Translate.menuItem("HelpPlugin:WhatsThis", this, "what"));

                //item.setEnabled(enabled && (helplib == JAVAHELP_LIB));

                //helpmenu.add(item=Translate.menuItem("HelpPlugin:LiveHelp", this, "chat"));

                //helpmenu.addSeparator();
                
                BMenuItem onlineHelpItem = Translate.menuItem("HelpPlugin:OnlineHelp", this, "onlineHelp");
    ...
    public void init()
    {
        ...
        System.out.println("Help prefdir: " + prefdir);
    ...
    public void onlineHelp(){
        try {
            ...
            desk.browse(new URI("http://armaautomotive.com/build/ads.php"));
        } catch (Exception e){
	...
	try {
	    ...
	    int imageNumber = new Random(System.currentTimeMillis()).nextInt(3); // 8
		...
		"Arma Design Studio v" + vname +
		"<br>Copyright 2020-2023 by Arma Automotive Inc."+
		"<br>Portions from Art Of Illusion " +
		...
		"<br>" + Translate.text("HelpPlugin:memory", new Object[] {
			...
			Long.valueOf(runtime.totalMemory() / MB),
			Long.valueOf(runtime.maxMemory() / MB),
		    }) +
		"<br>" + Translate.text("HelpPlugin:cpus", Integer.valueOf(cpus)) +
		"<br>" + Translate.text("HelpPlugin:opengl",
					...
					(ArmaDesignStudio.getPreferences().getUseOpenGL()
