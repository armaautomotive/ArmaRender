...
/** GCodeImporter implements the importing of GCode files. */

public class GCodeImporter
{
  public static void importFile(BFrame parent, Scene theScene)
  {
    BFileChooser bfc = new BFileChooser(BFileChooser.OPEN_FILE, "GCode Import"); // Translate.text("importOBJ")
    ...
    if (objName.lastIndexOf('.') > 0)
      ...
      System.out.println("Import GCode name: " + objName);
    ...
    try
      ...
      {
          System.out.println("******"   );
        System.out.println("CGode Import Ex: "   );
