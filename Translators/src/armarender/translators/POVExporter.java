...
public class POVExporter
{
	...
	ArmaRender.setCurrentDirectory(fc.getDirectory().getAbsolutePath());
	...
	write("// Produced by Arma Automotive - Arma Render "+ArmaRender.getVersion(), out, 0);
	...
	if (bIncludeFile) {
	    ...
	    write("// Produced by Aema Automotive - Arma Design Studio "+ArmaRender.getVersion(), out2, 0);
	...
	*/
	...
	// Cube setting
		...
		System.err.println("Gr??e:"+size.times(2.0).toString());
	...
	// (only for testing purposes in an extra loop)
		...
		System.err.println("// Mittelpunkt:\t"+orig.toString());
		System.err.println("// Gre:\t"+size.times(2.0).toString());
