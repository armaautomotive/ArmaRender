...
public class CreateCurveTool extends EditingTool
{
  ...
  public void mouseReleased(WidgetMouseEvent e, ViewerCanvas view)
  {
    ...
    if (e.getClickCount() != 2)
      {
          // if not on selected obj, deselect.
          ...
          for (i = 0; i < sel.length; i++)
          {
            ...
            if (!info.isLocked() && bounds != null && !info.isChildrenHiddenWhenHidden() && pointInRectangle(dragPoint, bounds))
            {
        ...
        int sel[] = ((LayoutWindow) theWindow).getSelectedIndices();
          ...
          if(sel.length == 1){
              ...
              if(existingSelectedInfo != null
                 ...
                 //||
                 //
                  && existingSelectedInfo.getObject() instanceof Curve == false
                  )
                ){
