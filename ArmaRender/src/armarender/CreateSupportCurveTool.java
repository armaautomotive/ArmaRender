...
public class CreateSupportCurveTool extends EditingTool
{
  ...
  public CreateSupportCurveTool(EditingWindow fr)
  {
    super(fr);
    //initButton("supportInterpCurve");
      initButton("supportInterpCurve_48");
  ...
  {
    super.activate();
    theWindow.setHelpText("Cureate Support Curve"); // Translate.text("createSupportCurveTool.helpText")
  }
  ...
  {
    return "Create a support curve to define curvature between two other curves."; // Translate.text("createSupportCurveTool.tipText");
  }
