 ...
 * <p>
 * The resource bundle is created from a {@link armarender.PluginRegistry.PluginResource PluginResource}
 * of type "TranslateBundle" provided by the {@link armarender.PluginRegistry PluginRegistry}.
 * By default it uses the PluginResource with ID "armarender" which is built into the application,
