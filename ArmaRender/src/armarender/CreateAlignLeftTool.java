...
public class CreateAlignLeftTool extends EditingTool
{
  ...
  public CreateAlignLeftTool(EditingWindow fr)
  {
    super(fr);
    initButton("alignLeft");
  ...
  {
    super.activate();
    theWindow.setHelpText(Translate.text("createAlignLeftTool.helpText"));
  }
  ...
  {
      return "Align selection to the next leftward object."; // Translate.text("createCurveTool.tipText");
  }
