...
public class CreateAlignRightTool extends EditingTool
{
  ...
  public CreateAlignRightTool(EditingWindow fr)
  {
    super(fr);
    initButton("alignRight");
  ...
  {
    super.activate();
    theWindow.setHelpText(Translate.text("createAlignRightTool.helpText"));
  }
  ...
  {
      return "Align selection to the next rightward object."; // Translate.text("createCurveTool.tipText");
  }
