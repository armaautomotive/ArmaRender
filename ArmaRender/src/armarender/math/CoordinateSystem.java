...
public class CoordinateSystem
{
  ...
  */
  ...
  /** Set the orientation of this CoordinateSystem.
      @param x        the rotation angle around the x axis (Degrees)
      @param y        the rotation angle around the y axis (Degrees)
      @param z        the rotation angle around the z axis (Degrees)
  */
  ...
  public final void setOrientation(double x, double y, double z)
  {
    ...
    /**
     * setOrientation
     * Description: Set orientation from a normal vector. Calculate a random updir automatically.
     *  --- EXPERIMENTAL ---
     */
    public final void setOrientation(Vec3 zdir){
        Vec3 updir = new Vec3(1,1,0); // X and Y are inputs, equation solves for Z.
        if(zdir.z == 0){
            zdir.z = zdir.z + 0.00001;
        }
        double z2 = (-zdir.x * updir.x - zdir.y * updir.y) / zdir.z;
        updir.z = z2;
