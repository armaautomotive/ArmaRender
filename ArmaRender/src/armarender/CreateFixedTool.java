...
public class CreateFixedTool extends EditingTool
{
  ...
  public CreateFixedTool(EditingWindow fr)
  {
    super(fr);
    //initButton("force");
      initButton("fixed_48");
  ...
  {
      return "Create force (FEA) object between two points."; // Translate.text("createCurveTool.tipText");
  }
