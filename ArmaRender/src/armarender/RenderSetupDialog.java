...
import armarender.vector.*; // Vector Renderer
...
public class RenderSetupDialog
{
  ...
  static int currentCamera = 0, width = 800, height = 600; // 800 x 600  640 480
  ...
  public RenderSetupDialog(BFrame parent, Scene theScene)
  {
    ...
    renderers = PluginRegistry.getPlugins(Renderer.class);
      ...
      renderers.add(vectorRenderer);
      
      
    if (currentRenderer == null){
      //System.out.println(" - RenderSetupDialog currentRenderer is null  - ");
      currentRenderer = ArmaRender.getPreferences().getDefaultRenderer();
