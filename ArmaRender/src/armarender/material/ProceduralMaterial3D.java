...
{  
  ...
  {
    armarender.procedural.Module modules[] = proc.getModules();
  ...
  public ProceduralMaterial3D(DataInputStream in, Scene theScene) throws IOException, InvalidObjectException
  {
    ...
    if (version == 0)
    {
      ...
      OutputModule output[] = proc.getOutputModules();
      armarender.procedural.Module fromModule[] = new armarender.procedural.Module [output.length];
  ...
  private void linkModuleToOutput(armarender.procedural.Module module, OutputModule output)
  {
