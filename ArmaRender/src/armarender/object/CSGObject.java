...
public class CSGObject extends Object3D
{
  ...
  BoundingBox bounds;
    ...
    Vector<ObjectInfo> additionalObjects = new Vector<ObjectInfo>(); // depricate
    Vector<Integer> additionalOperations = new Vector<Integer>();    // depricate
  ...
  public CSGObject(ObjectInfo o1, ObjectInfo o2, int op)
  {
     ...
     * addAdditionalObject
     *
     * Description: Add an additional object to merge.
     */
    public void addAdditionalObject(ObjectInfo oi, int op){
        System.out.println("addAdditionalObject() ");
        additionalObjects.addElement(oi);
        additionalOperations.addElement(new Integer(op));
    }
    
    public Vector<ObjectInfo> getAdditionalObjects(){
        return additionalObjects;
    }
    
    public Vector<Integer> getAdditionalOperations(){
        return additionalOperations;
    }
    
    public void setCoordinateSystem(CoordinateSystem cs){
        this.cs = cs;
        //System.out.println(" setCoordinateSystem " + cs.getOrigin() );
    }
  ...
  public Object3D duplicate()
  {
    ...
    obj.copyTextureAndMaterial(this);
      ...
      for(int i = 0; i < additionalObjects.size(); i++){
          ObjectInfo oi = additionalObjects.elementAt(i).duplicate();
          int op = (int)additionalOperations.elementAt(i);
          obj.addAdditionalObject(oi, op);
      }
      obj.setCoordinateSystem(cs);
  ...
  {
    //System.out.println("CSG convertToTriangleMesh() ");
    //System.out.println(" CSGObject  convert " + obj1.getName() + obj1.getId() +  " " + obj2.getName() + obj2.getId()  );
    TriangleMesh mesh1, mesh2;
   
    //System.out.println("_"+ obj1.getId());
    ...
    CSGModeller modeller = new CSGModeller(mesh1, mesh2, obj1.getCoords(), obj2.getCoords(),  obj1.getName() + "," + obj2.getName() );
    ...
    //System.out.println(" ("+ obj1.getId() +  "," + obj2.getId()+") ");
      ...
      // If additional objects add them
      //System.out.println("Additional objects:  " + additionalObjects.size() + "   *** ");
      for(int i = 0; i < additionalObjects.size(); i++){
          ObjectInfo oi = additionalObjects.elementAt(i);
          int op = (int)additionalOperations.elementAt(i);
          
          //System.out.println("Additional object.  ");
          TriangleMesh additionalMesh = oi.getObject().convertToTriangleMesh(tol);
          
          // Vec3 center = newobj.centerObjects();
          // new CoordinateSystem(center, Vec3.vz(), Vec3.vy())
          CoordinateSystem cs_2 = oi.getCoords().duplicate();
          if(cs != null ){
              cs_2.getOrigin().subtract( cs.getOrigin() );
          }
          
          CoordinateSystem cs_ = obj1.getCoords();
          if(cs != null){
              //cs_ = cs;
          ...
          CSGModeller additionalModeller = new CSGModeller(trimesh,
                                                           additionalMesh,
                                                           existingCS, // cs_, // obj1.getCoords() get new centre??? ***
                                                           cs_2, // oi.getCoords(), // This is correct? 
                                                           "additional" );
          TriangleMesh additionalTrimesh = additionalModeller.getMesh(op, getTexture());
          additionalTrimesh.copyTextureAndMaterial(this);
          
          trimesh = additionalTrimesh;
      }
    return trimesh;
  }
  ...
  public RenderingMesh getRenderingMesh(double tol, boolean interactive, ObjectInfo info)
  {
    ...
    //return convertToTriangleMesh(tol).getRenderingMesh(tol, false, info);
      ...
      RenderingMesh rm = mesh.getRenderingMesh(tol, false, info);
  ...
  public WireframeMesh getWireframeMesh()
  {
    ...
    return (WireframeMesh) cacheMeshes(ArmaRender.getPreferences().getInteractiveSurfaceError(), null)[1];
  }
  ...
  {
    //System.out.println(" cacheMeshes ");
    TriangleMesh mesh = convertToTriangleMesh(tol);
  ...
  public void writeToFile(DataOutputStream out, Scene theScene) throws IOException
  {
    ...
    obj2.getObject().writeToFile(out, theScene);
      ...
      out.writeInt(additionalObjects.size()); // number of additional objects. Used to read the objects from the file.
      for(int i = 0; i < additionalObjects.size(); i++){
          ObjectInfo oi = additionalObjects.elementAt(i).duplicate();
          int op = (int)additionalOperations.elementAt(i);
          
          out.writeInt(op);
          oi.getCoords().writeToFile(out);
          out.writeUTF(oi.getName());
          out.writeUTF(oi.getObject().getClass().getName());
          oi.getObject().writeToFile(out, theScene);
      }
  }
    ...
    try
      {
        ...
        Class cls = ArmaRender.getClass(in.readUTF());
        ...
        cls = ArmaRender.getClass(in.readUTF());
  ...
  public static class CSGKeyframe implements Keyframe
  {
    ...
    public CSGKeyframe(DataInputStream in, Object parent) throws IOException
    {
      ...
      try
      {
        Class cl = ArmaRender.getClass(in.readUTF());
        ...
        cl = ArmaRender.getClass(in.readUTF());
