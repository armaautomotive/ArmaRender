...
/**
 Object represents collidable geometry and velocity for FEA simulation.
...
public class ImpactCube extends Object3D
{
  ...
  public ImpactCube(double xsize, double ysize, double zsize)
  {
    halfx = xsize/2.0;
    halfy = ysize/2.0;
    halfz = zsize/2.0;
  ...
  {
    ImpactCube obj = new ImpactCube(halfx*2.0, halfy*2.0, halfz*2.0);
  ...
  public ImpactCube(DataInputStream in, Scene theScene) throws IOException, InvalidObjectException
  {
    super(in, theScene);
