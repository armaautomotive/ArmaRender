...
public abstract class Object3D
{
  ...
  */
  ...
  public abstract WireframeMesh getWireframeMesh();
    ...
    {
        renderObject( obj,  canvas,  viewDir, null);
    }
   ...
   */
  public void renderObject(ObjectInfo obj, ViewerCanvas canvas, Vec3 viewDir, Camera cameraOveride)
  {
      if(obj != null){
    ...
    if(cameraOveride != null){
        theCamera = cameraOveride;
    }
    ...
    int objectOverride = obj.getDisplayModeOverride();
      //System.out.println("objectOverride: " + objectOverride + " renderMode " + renderMode);
      if(objectOverride > 0){
          renderMode = objectOverride - 1; // Overide this object render mode.
      }
    ...
    if (mesh != null)
    {
      ...
      if (renderMode == ViewerCanvas.RENDER_TRANSPARENT)
      {
        ...
        //canvas.renderMeshTransparent(mesh, shader, theCamera, obj.getCoords().toLocal().timesDirection(viewDir), null);
          ...
          canvas.renderMeshTransparent2(mesh, shader, theCamera, obj.getCoords().toLocal().timesDirection(viewDir), null, obj.getObject().isClosed());
      }
      else
      {
        double time = 0.0;
      ...
      if(obj.object instanceof SplineMesh){
        ...
        ((SplineMesh)obj.object).drawFirstPoint(canvas);
      }
    }
    else {
      canvas.renderWireframe(obj.getWireframePreview(), theCamera, ViewerCanvas.lineColor);
  ...
  public void writeToFile(DataOutputStream out, Scene theScene) throws IOException
  {
    ...
    if (canSetTexture())
      ...
      // write ObjectInfo isHiddenByParent
  }
    ...
    if (i > -1)
      {
        try
          {
            Class mapClass = ArmaRender.getClass(in.readUTF());
        ...
        try
          {
            ...
            Class mapClass = ArmaRender.getClass(classname);
  ...
  public static ParameterValue readParameterValue(DataInputStream in) throws IOException
  {
    try
    {
      Class valueClass = ArmaRender.getClass(in.readUTF());
