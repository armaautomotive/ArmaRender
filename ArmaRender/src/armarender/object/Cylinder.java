...
public class Cylinder extends Object3D
{
  ...
  private static final int SEGMENTS = 32; // 16
  private int minSubdivisions = 3;
  ...
  public void setSize(double xsize, double ysize, double zsize)
  {
     ...
     * getWireframeMesh
     *
     * Description: Called in wireframe display mode.
     */
  public WireframeMesh getWireframeMesh()
  {
    ...
    //System.out.println("Cylendar getWireframeMesh **** ");
  ...
  {
    //System.out.println("Cylendar convertToTriangleMesh   ****** ");
    ...
    v[3] = new Vec2(0.0, rz);
    int count = 0;
    while ( (!withinTolerance(v, tol)  && count < 5) || (count < minSubdivisions) ) //
      {
        vtemp = v;
  ...
  {
    //System.out.println("Cylendar getRenderingMesh * " + tol);
    ...
    int count = 0;
      // count 2 = min 16 point circle, 3 = 32 points.
    while ( (!withinTolerance(v, tol) && count < 5) || (count < minSubdivisions) ) // limit subdivisions and require min subdivisions.
      {
        vtemp = v;
        v = new Vec2 [v.length*2];
