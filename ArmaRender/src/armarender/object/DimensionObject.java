...
public class DimensionObject extends Curve implements Mesh
{
    ...
    public Object3D duplicate()
    {
        ...
        return new DimensionObject(v, s, smoothingMethod, closed);
    }
    
    public void copyObject(Object3D obj)
    {
        DimensionObject cv = (DimensionObject) obj;
    ...
    public DimensionObject subdivideDimension()
    {
        ...
        if (vertex.length == 2)
        {
            ...
            return new DimensionObject(newpos, news, smoothingMethod, closed);
        }
        Vec3 v[] = new Vec3 [vertex.length];
        for (int i = 0; i < v.length; i++)
            v[i] = new Vec3(vertex[i].r);
    ...
    public DimensionObject subdivideDimension(int times)
    {
        DimensionObject c = this;
    ...
    public DimensionObject(DataInputStream in, Scene theScene) throws IOException, InvalidObjectException
    {
        super(in, theScene);
    ...
    {
        return new DimensionKeyframe(this);
    }
