...
public class TitleWindow extends BWindow
{
  ...
  public TitleWindow()
  {
    ...
    ImageIcon image = new ImageIcon(getClass().getResource("/armarender/titleImages/titleImage"+imageNumber+".jpg"));
    String text = "<html><div align=\"center\">"+
        "Arma Render v"+ArmaRender.getVersion()+
        "<br>Copyright 2018-2023 Arma Automotive and" +
