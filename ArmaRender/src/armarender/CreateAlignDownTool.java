...
public class CreateAlignDownTool extends EditingTool
{
  ...
  public CreateAlignDownTool(EditingWindow fr)
  {
    super(fr);
    initButton("alignDown");
  ...
  {
    super.activate();
    theWindow.setHelpText(Translate.text("createAlignDownTool.helpText"));
  }
  ...
  {
      return "Align selection to the next downward object."; // Translate.text("createCurveTool.tipText");
  }
