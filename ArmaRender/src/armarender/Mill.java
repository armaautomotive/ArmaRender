/* Copyright (C) 2019,2023, 2024 by Jon Taylor
...
public class Mill extends Thread {
    ...
    public boolean getUserInput(){
        ...
        int result = JOptionPane.showConfirmDialog(null, panel, "CNC Mill Properties", JOptionPane.OK_CANCEL_OPTION, JOptionPane.OK_CANCEL_OPTION, iconImage);
    ...
    public void exportGCode(){
        ...
        String dir = scene.getDirectory() + System.getProperty("file.separator") + sceneName; // + "_gCode3d";
        File d = new File(dir);
        if(d.exists() == false){
            d.mkdir();
        }
        ...
        dir = scene.getDirectory() + System.getProperty("file.separator") + sceneName + System.getProperty("file.separator") + "mill3axis"; // mesh3
        d = new File(dir);
        if(d.exists() == false){
            d.mkdir();
        }
