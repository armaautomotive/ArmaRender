...
public class ProcedureEditor extends CustomWidget
{
  ...
  public void saveState(boolean redo)
  {
    ...
    if (stack.size() == ArmaRender.getPreferences().getUndoLevels())
      stack.remove(0);
  ...
  private void undo()
  {
    ...
    if (redoStack.size() == ArmaRender.getPreferences().getUndoLevels())
      redoStack.remove(0);
  ...
  private void redo()
  {
    ...
    if (undoStack.size() == ArmaRender.getPreferences().getUndoLevels())
      undoStack.remove(0);
