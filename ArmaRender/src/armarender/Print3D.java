...
public class Print3D extends Thread {
    ...
    private double accuracy = 0.2; //  0.03125  0.0393701; // 0.019685 = 0.5mm,  0.03125; // 1/32" .8mm   grid point length quanta_length
    ...
    private double layer_thickness = 0.2; // .1
    ...
    public boolean getUserInput(){
        ...
        widthLabel.setBounds(0, yHeight, 130, 40); // x, y, width, height
   //     panel.add(widthLabel);
        
        JTextField widthField = new JTextField(new String(width+""));
        widthField.setBounds(130, yHeight, 130, 40); // x, y, width, height
   //     panel.add(widthField);
        ...
        labelDepth.setBounds(0, yHeight, 130, 40); // x, y, width, height
    //    panel.add(labelDepth);
        
        JTextField depthtField = new JTextField( new String(depth+""));
        depthtField.setBounds(130, yHeight, 130, 40); // x, y, width, height
    //    panel.add(depthtField);
        ...
        labelHeight.setBounds(0, yHeight, 130, 40); // x, y, width, height
        panel.add(labelHeight);
        
        JTextField heightField = new JTextField(new String(material_height+""));
        heightField.setBounds(130, yHeight, 130, 40); // x, y, width, height
        ...
        labelAccuracy.setBounds(0, yHeight, 130, 40); // x, y, width, height
        panel.add(labelAccuracy);
        
        JTextField accuracyField = new JTextField(new String(accuracy + ""));
        accuracyField.setBounds(130, yHeight, 130, 40); // x, y, width, height
        ...
        labelBit.setBounds(0, yHeight, 130, 40); // x, y, width, height
        panel.add(labelBit);
        
        JTextField bitField = new JTextField("0.0393701");
        bitField.setBounds(130, yHeight, 130, 40); // x, y, width, height
        panel.add(bitField);
        ...
        labelLayerThickness.setBounds(0, yHeight, 130, 40); // x, y, width, height
        panel.add(labelLayerThickness);
        
        JTextField layerThicknessField = new JTextField("0.5");
        layerThicknessField.setBounds(130, yHeight, 130, 40); // x, y, width, height
        ...
        labelWallThickness.setBounds(0, yHeight, 130, 40); // x, y, width, height
        panel.add(labelWallThickness);
        
        JTextField wallThicknessField = new JTextField( new String(wall_thickness+""));
        wallThicknessField.setBounds(130, yHeight, 130, 40); // x, y, width, height
        ...
        pathBit.setBounds(0, yHeight, 130, 40); // x, y, width, height
        panel.add(pathBit);
        
        JCheckBox toolpathCheck = new JCheckBox("");
        toolpathCheck.setBounds(130, yHeight, 130, 40); // x, y, width, height
        ...
        optimizationLabel.setBounds(0, yHeight, 130, 40); // x, y, width, height
        panel.add(optimizationLabel);
        
        JCheckBox optimizationCheck = new JCheckBox("");
        optimizationCheck.setBounds(130, yHeight, 130, 40); // x, y, width, height
        ...
        minimizePassesLabel.setBounds(0, yHeight, 130, 40); // x, y, width, height
        panel.add(minimizePassesLabel);
        
        JCheckBox minimizePassesCheck = new JCheckBox("");
        minimizePassesCheck.setBounds(130, yHeight, 130, 40); // x, y, width, height
    ...
    public void exportGCode(){
        ...
        // Find all surfaces in vertical lines. 
        //
        ...
        System.out.println("Markup Solids.");
