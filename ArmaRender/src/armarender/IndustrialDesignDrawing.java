...
public class IndustrialDesignDrawing extends JFrame implements ActionListener {
    ...
    public IndustrialDesignDrawing(LayoutWindow l){
        layout = l;
        System.out.println("Industrial Design Drawing");
        Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        
        this.setTitle("Industrial Design Drawing");
        
        Scene theScene = layout.getScene();
        ...
        //
        y+= (ySeperation/2) - 10;
        connectionStatusLabel = new JLabel("Select Camera:");
        ...
        Vector cameraObjectList = new Vector();
        for(int i = 0; i < objects.size(); i++){
            ObjectInfo info = (ObjectInfo)objects.elementAt(i);
            if(info.getObject() instanceof SceneCamera){
                cameraObjectList.addElement(info);
            }
        }
        String[] cameraStrings = new String[cameraObjectList.size()];
        for(int i = 0; i < cameraObjectList.size(); i++){
            ObjectInfo info = (ObjectInfo)cameraObjectList.elementAt(i);
            cameraStrings[i] = info.getName();
        }
        JComboBox cameraSelectList = new JComboBox(cameraStrings);
        cameraSelectList.setBounds(20, y, 255, 33);
        cameraSelectList.setPreferredSize(new Dimension(255, 33));
        cameraSelectList.addActionListener(this);
        leftPanel.add(cameraSelectList);
        ...
        lineThicknessLabel.setBounds(20 + 3, y, 155,33);
        leftPanel.add(lineThicknessLabel);
        
        JTextField lineThicknessTextField = new JTextField(20);
        //lineThicknessTextField = new JButton("Load File");
        lineThicknessTextField.setBounds(185, y, 90, 33);
        //lineThicknessTextField.addActionListener( this );
        leftPanel.add(lineThicknessTextField);
        ...
        //
        y+= ySeperation;
        JLabel shadingThicknessLabel = new JLabel("Shading Thickness");
        //stopButton.setBackground(Color.RED);
        //stopButton.setOpaque(true);
        shadingThicknessLabel.setBounds(20 + 3, y, 155,33); // x,y,w,h
        leftPanel.add(shadingThicknessLabel);
        
        JTextField shadingThicknessTextField = new JTextField(20);
        //lineThicknessTextField = new JButton("Load File");
        shadingThicknessTextField.setBounds(185, y, 90, 33);
        //lineThicknessTextField.addActionListener( this );
        leftPanel.add(shadingThicknessTextField);
        ...
        y+= ySeperation;
        JLabel inProgressLabel = new JLabel("This feature is in development");
        inProgressLabel.setBounds(20, y, 255,33);
        leftPanel.add(inProgressLabel);
        
        y+= ySeperation;
        JButton saveButton = new JButton("Save");
        saveButton.setForeground(new Color(50, 50, 200));
        saveButton.addActionListener( this );
        saveButton.setBounds(154, y, 121, 33); // x,y,w,h
        ...
        */
        ...
        centerPreviewPanel.setBackground(new Color(255,255,255));
        ...
        */
        ...
        JSplitPane sp = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, leftPanel, centerPreviewPanel );
