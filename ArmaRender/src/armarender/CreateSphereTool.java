            ...
            if(existingSelectedInfo != null
               ...
               // existingSelectedInfo.getObject() instanceof Curve)
                ...
                if(existingSelectedInfo.getObject() instanceof  Folder){
                    ...
                    if(f.getAction() == Folder.SUBTRACT || f.getAction() == Folder.INTERSECTION){
                        objInfo.setDisplayModeOverride( ViewerCanvas.RENDER_TRANSPARENT + 1);
                        objInfo.clearCachedMeshes();
                        //System.out.println("sel " + existingSelectedInfo.getName() );
                        ...
                        if(parent != null){
                            ...
                            //System.out.println("parent to transparent: " + parent.getName() );
      ...
      if(dragOccured == true){
          ...
          if(rebuildBooleanScene){
              if(theWindow instanceof LayoutWindow){
                  //((LayoutWindow)theWindow).booleanSceneCommand(); // rebuilding entire scene boolean objects is performance issue.
