...
public class CreateExportRegionTool extends EditingTool
{
  ...
  {
      return "Create export region space to limit scene geometry for parts."; // Translate.text("createCurveTool.tipText");
  }
