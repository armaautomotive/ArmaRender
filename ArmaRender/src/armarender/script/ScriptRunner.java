...
public class ScriptRunner
{
  ...
  private static final String IMPORTS[] = {"armarender.*", "armarender.image.*", "armarender.material.*",
      "armarender.math.*", "armarender.object.*", "armarender.script.*", "armarender.texture.*",
      "armarender.ui.*", "buoy.event.*", "buoy.widget.*"};
