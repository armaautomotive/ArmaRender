...
public class CreateArcTool extends EditingTool
{
  ...
  public CreateArcTool(EditingWindow fr)
  {
    super(fr);
    initButton("arc_48");
  ...
  {
    super.activate();
    theWindow.setHelpText(Translate.text("createArcTool.helpText"));
  }
  ...
  {
      return "Create Arc Tube"; // Translate.text("createCurveTool.tipText");
  }
    ...
    if (clickPoint.size() > 1)
      {
        ...
        theCurve = new ArcObject(vertex, s, smoothing, false);
    ...
    if (addCurve)
      {
        ...
        ObjectInfo info = new ObjectInfo(theCurve, coords, "Arc Tube "+(counter++));
  ...
  public void iconDoubleClicked()
  {
    ...
    if (smoothing == Mesh.INTERPOLATING)
      ...
      ComponentsDialog dlg = new ComponentsDialog(theFrame, Translate.text("Arc Properties"), // selectCurveSmoothing
