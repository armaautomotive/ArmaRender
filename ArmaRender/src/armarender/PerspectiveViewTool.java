...
public class PerspectiveViewTool extends EditingTool
{
  ...
  public PerspectiveViewTool(LayoutWindow fr)
  {
    super(fr);
    initButton("perspective_48");
  }

  public void activate()
  {
    super.activate();
    theWindow.setHelpText(Translate.text("perspectiveTool.helpText"));
  }
  ...
  {
    return Translate.text("perspectiveViewTool.tipText");
  }
  ...
  public void mousePressed(WidgetMouseEvent e, ViewerCanvas view)
  {
    ...
    System.out.println("Perspective clicked.");
  }
  ...
  public void mouseReleased(WidgetMouseEvent e, ViewerCanvas view)
  {
    ...
    {
        //System.out.println("Perspective 2X clicked.");
    }
    ...
    public void iconSingleClicked(MouseClickedEvent e)
    {
        ...
        lw.getView().setPerspective(true);
        
        // Need to reselect tool.
        // setTool(EditingTool tool)   getToolPalette
