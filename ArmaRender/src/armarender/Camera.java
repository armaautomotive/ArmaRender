...
public class Camera implements Cloneable
{
  ...
  public Camera duplicate()
  {
    ...
    public Camera duplicate2(){
        Camera c = new Camera();
        
        //c.setSize(this.getSize());
        
        c.cameraCoords = cameraCoords.duplicate(); // getCameraCoordinates
        return c;
    }
  ...
  public Rectangle findScreenBounds(BoundingBox bb)
  {
    ...
    /**
     * findScreenPos
     * Description: Convert 3d point to 2d screen coords.
     */
    public Vec2 findScreenPos(Vec3 vec){
        if(vec == null){
            return null;
        }
        Vec2 p;
        ...
        p = objectToScreen.timesXY(vec);
        z = objectToView.timesZ(vec);
