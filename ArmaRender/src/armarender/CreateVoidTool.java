...
public class CreateVoidTool extends EditingTool
{
  ...
  public CreateVoidTool(EditingWindow fr)
  {
    super(fr);
    initButton("void");
  ...
  {
      return "Create void space not to be filled."; // Translate.text("createCurveTool.tipText");
  }
